...
export class GlobalAccount {
  ...
  getInitialBuyPricePredicted(amount: bigint, vSolReserves: bigint, vTokenReserves: bigint, rTokenReserves: bigint): bigint {
    if (amount <= 0n) {
      return 0n;
    }
    ...
    return s < rTokenReserves
        ? s
        : rTokenReserves;
  }

  getInitialSellPricePredicted(amount: bigint, feeBasisPoints: bigint, vSolReserves: bigint, vTokenReserves: bigint): bigint {
    if (amount <= 0n) {
      return 0n;
    }
